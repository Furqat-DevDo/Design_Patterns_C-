...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/dotnet/sdk:7-alpine AS build
...
FROM mcr.microsoft.com/dotnet/aspnet:7-alpine AS final
WORKDIR /app
...
ENTRYPOINT ["dotnet", "Design_Patterns_C#.dll"]
